    ...
    <main className="min-h-screen bg-slate-50 transition-colors duration-500 dark:bg-[#020617]">
      ...
      <section className="relative overflow-hidden pt-26 pb-10 md:pt-32 md:pb-15">
        ...
        <div className="relative z-10 container mx-auto max-w-5xl px-6">
          ...
          <h1 className="font-heading text-3xl font-bold tracking-tight text-slate-900 md:text-6xl dark:text-white">
            Privacy Policy
          </h1>
          <p className="mt-4 text-base text-slate-500 md:text-lg dark:text-slate-400">
      ...
      <div className="container mx-auto max-w-5xl px-6 pb-20">
        <article className="space-y-6 rounded-2xl border border-slate-200 bg-white p-7 leading-relaxed text-slate-700 dark:border-white/10 dark:bg-white/5 dark:text-slate-200">
          <p>
            ...
            protect information when you visit our website or communicate with
            us.
          </p>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>
                Evaluate potential collaboration and project opportunities
              </li>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              Dhaka, Bangladesh
              <br />
              Email: mcs2024.survey@gmail.com
            </p>
          </section>
        </article>
      </div>
